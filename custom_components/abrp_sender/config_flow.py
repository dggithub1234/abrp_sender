...
class ABRPSenderConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(self, user_input=None):
        ...
        location_selector = (
            ...
            if gps_entities else selector.EntitySelector({"domain": "device_tracker"})
        )
        ...
        schema = vol.Schema(
            {
                ...
                vol.Optional("odometer_sensor", default=options.get("odometer_sensor", data.get("odometer_sensor"))): selector.EntitySelector({"domain": "sensor"}),
